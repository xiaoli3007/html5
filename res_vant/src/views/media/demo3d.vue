...
<script>
	...
	export default {
		...
		data() {
			return {
				 playurl: "static/3d/青铜器5_2.gltf",
				//playurl:"static/3d/shangzhou/1.gltf",
				// playurl:"static/3d/aaa/lidded_ewer-150k-4096.gltf",
				catid: 0,
				news_id: 0,
				media_id: 0,
				jindu: 0,
		...
		methods: {
				...
				return new Promise(function(resolve, reject) {
					...
					loader.load(
						...
						gltf => {
							...
							// 	// let material = new Three.MeshPhysicalMaterial({color: 0xce2193   });
			...
			initCamera() {
				...
				this.camera = new Three.PerspectiveCamera(500, this.width / this.height, 0.25, 10000)
